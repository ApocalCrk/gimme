...
class TransactionScreen extends StatefulWidget {
  ...
  const TransactionScreen({Key? key, required this.dataTransaction})
      : super(key: key);
                        ...
                        child: Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  widget.dataTransaction['payment_method'] =
                                      value;
                                  dragPanel = true;
                                });
                              },
                ...
                TransactionController()
                  ...
                  if (val['status'] == 'success') {
                    ...
                    transaction.created_at =
                        DateTime.parse(val['data']['created_at']);
                    transaction.updated_at =
                        DateTime.parse(val['data']['updated_at']);
                    Future.delayed(const Duration(seconds: 2)).then((_) {
                      Navigator.pushReplacementNamed(
                          context, '/gym/checkout/success',
              ...
              panel: panel_open
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          Lottie.asset('assets/images/icon/success_pay.json',
                              repeat: false),
                          Text(
